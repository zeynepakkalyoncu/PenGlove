...
void setup() {
  ...
  kalmanX.setStartingAngle(roll); // Set starting angle
...
//  double posz = trans.getAbsolutePosition(kalAngleX, kalAngleY, -90, gyroXrate, gyroYrate, 0, dt, 3) * 0.001;
//  Serial.print(posz); Serial.print("\t");
*/
  double velx = trans.getAbsoluteVelocity(kalAngleX, kalAngleY, 0, gyroXangle, gyroYangle, 0, dt, 3) * 0.01;
  Serial.print(velx); Serial.print("\t");
  double vely = trans.getAbsoluteVelocity(kalAngleX, kalAngleY, 0, gyroXangle, gyroYangle, 0, dt, 1) * 0.01;
